  ...
  const cards = [
    {
      ...
      description: "Simply say what matters, and your companion\ntakes care of the rest — no more manual input.",
      image: "/modern-dashboard-interface-with-data-visualization.jpg",
    },
    {
      title: "Integrated system",
      description: "Everything in one place — tasks, calendar, habits,\nand deep work tracking unified into one flow.",
      image: "/analytics-dashboard.png",
    },
    {
      title: "Proactive insights",
      description: "Get automated reflections, progress tracking,\nand actionable insights that help you work smarter.",
    ...
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          ...
          />
          <div className="self-stretch font-serif text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-medium leading-tight md:leading-[50px]  tracking-tight">
            Effortless productivity, integrated and intelligent
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            Voice-first interaction, unified system, and proactive companion
            <br />
            that helps you take control, not lose it.
          </div>
        </div>
      </div>
