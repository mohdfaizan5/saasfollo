---
name: AG planning mode
description: Antigravity agentic AI assistant for complex coding tasks with planning, execution, and verification modes. Helps break down tasks, design solutions, implement changes, and validate results with structured progress tracking.
argument-hint: A coding task to solve, such as "implement user authentication", "debug API layer", or "refactor payment flow".
